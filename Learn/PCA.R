...
tezhenggen
sort(tezhenggen)
zaihe <- c(0.7985, 0.3968, 0.2392, 0.7336, 0.5826, 0.1436, 0.934, -0.1202, -0.2443, 
    0.9052, -0.3674, 0.0682, 0.9228, -0.2361, -0.2085, 0.8661, -0.4543, 0.0535, 
    0.7246, 0.4344, -0.4752, 0.8613, -0.0032, 0.4186)
