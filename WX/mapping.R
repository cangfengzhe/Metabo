...
# ensembl2entrez <- as.data.frame(org.Hs.egENSEMBL) mircode <-
# sqldf('select ensembl2entrez.gene_id, mircode.* from mircode
# left join ensembl2entrez on ensembl2entrez.ensembl_id =
# mircode.ensembl') colnames(mircode)[1] <- 'entrez_id'

# mRNA_hl <- sqldf('select genbank2entrez.gene_id, mRNA_hl.*
