...
# R scripts generated  Sun Jan 11 21:55:51 EST 2015
...
gset <- getGEO("GSE43494",filename='./Raw_Data/GSE43494-GPL14613_series_matrix.txt.gz', GSEMatrix =TRUE)
...
title <- paste ("GSE43494", '/', annotation(gset), " selected samples", sep ='')
