...
pubmedText <- function(url) {
    # get the article's pmid, title, abstract, journal name and publish date.  url
    # url 输入的网址链接 e.g.
    ...
    # 读取网页内容，encoding 不设置会在使用substring()时出现multibite
    # 读取错误
    ...
    # bgtext <- as.ffdf(pubmed) #转为ffdf格式 （ff package�<U+383C><U+3E39>
} 
