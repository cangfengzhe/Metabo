all_data <- sqldf('select SGD.*, pars_sgd.mean as pars, protein_abun_sgd.abundance as protein_abundance, mf_all_seq_sgd.mf as all_seq_mf, mf_cds_sgd.cds_mf as cds_mf,mf_utr5_sgd.utr5_mf, mf_utr3_sgd.utr3_mf
from SGD left join pars_sgd on SGD.sgd_id = pars_sgd.sgd_id
                  ...
                  left join mf_utr3_sgd on mf_utr3_sgd.sgd_id = SGD.sgd_id')
