...
plot(g, layout = layout.fruchterman.reingold, vertex.label = nodes, 
    vertex.shape = "rectangle", vertex.size = nchar(nodes) * 5)

# Also need to: * colour by environment/namespace (use palette)
