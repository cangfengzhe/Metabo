...
PlotSubHeatMap <- function(imgName, format="png", dpi=72, width=NA, smplDist, clstDist, palette, method.nm, top.num, viewOpt, rowV=T, colV=T, border=T){
    ...
    PlotHeatMap(imgName, format, dpi, width, smplDist, clstDist, palette, viewOpt, rowV, colV, var.inx, border);
}


PlotHeatMap<-function(imgName, format="png", dpi=72, width=NA, smplDist, clstDist, palette, viewOpt="detail", rowV=T, colV=T, var.inx=NA, border=T){
...
PlotHeatMap2<-function(imgName, format="png", dpi=72, width=NA, smplDist='pearson', clstDist='average', colors="bwm", viewOpt="overview", hiRes=FALSE, sortInx = 2, var.inx=1:ncol(dataSet$norm)){
